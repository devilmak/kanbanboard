...
import { getFirestore, collection, doc, addDoc, updateDoc, deleteDoc, getDocs, where, query, onSnapshot } from 'firebase/firestore';
...
export { db, collection, doc, addDoc, updateDoc, deleteDoc, getDocs, where, query, onSnapshot };